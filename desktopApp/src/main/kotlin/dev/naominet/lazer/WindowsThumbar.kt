...
internal class WindowsThumbar(
    ...
    private val onBlockedByIntegrity: () -> Unit = {},
) {
    ...
    fun install(window: Window, playing: Boolean) {
        ...
        runCatching {
            ...
            hwnd = handle
            bridge = loadedBridge
            val result = loadedBridge.lazer_taskbar_install(
                handle,
                iconPath("previous"),
                iconPath("play"),
                iconPath("pause"),
            ...
            installed = result == TASKBAR_INSTALL_SUCCESS
            if (result == TASKBAR_INSTALL_BLOCKED_BY_INTEGRITY) {
                PlaybackDebugLog.event("thumbar-install-blocked-integrity")
...
private const val TASKBAR_INSTALL_SUCCESS = 1
private const val TASKBAR_INSTALL_BLOCKED_BY_INTEGRITY = 2
